...
###########################################
###########################################
model = ['Macroecological']    

roots = ['/mnt/lustre01/work/bb0820/ISIMIP/ISIMIP2b/OutputData/marine-fishery_global/MACROECOLOGICAL/', '/mnt/lustre01/work/bb0820/ISIMIP/ISIMIP2a/OutputData/marine-fishery_global/MACROECOLOGICAL/', '/mnt/lustre01/work/bb0820/ISIMIP/ISIMIP2b/OutputData/marine-fishery_global/MACROECOLOGICAL/']
run = ['ipsl-cm5a-lr','gfdl-reanalysis', 'gfdl-esm2m']
dirs = ['historical', 'future'] ## gfdl-reanalysis is historical only
fishing = ['no-fishing']
...
storage_root = "/pf/b/b380694/Regional/Output_Data/Macroecological" # Assuming function is run from home directory
storage_run = ['ipsl-cm5a-lr','gfdl-reanalysis', 'gfdl-esm2m']
